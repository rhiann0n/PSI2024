...
public class Lista {
    ...
    //1. Para concatenar dos listas vamos a crear una tercera lista donde
    //se guardará las dos listas

    public Lista concatenarListas(Lista l1, Lista l2) { //no se hace void
        Lista nuevaLista = new Lista();
        //for each
        for (Integer e:l1.elemento) {
            nuevaLista.insertarFinal(e);
        }
        for (Integer e:l2.elemento) {
            nuevaLista.insertarFinal(e);
        }
        System.out.println("El resultado de concatenar la lista 1 con la lista 2 es " +
